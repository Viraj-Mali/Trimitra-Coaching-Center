...
async function main() {
  ...
  await prisma.siteSettings.upsert({
    ...
    update: {
      ...
      mapsLink: 'https://maps.google.com/?q=Talegaon+Dighe+Pune',
  ...
  const courseData = [
    {
      ...
      metaTitle: 'Foundation Coaching for Class 6-9 | Trimitra Coaching Centre, Talegaon Dighe Pune',
      metaDescription: 'Best coaching classes for 6th to 9th standard in Talegaon Dighe, Pune. Small batches, personal attention, weekly tests. Trimitra Coaching Centre by Dr. Sarthak Dighe.',
    },
    {
      slug: '10th-board',
      ...
      metaTitle: '10th Board Coaching in Talegaon Dighe Pune | Trimitra Coaching Centre',
      metaDescription: 'Best 10th SSC Board coaching in Talegaon Dighe, Pune. Expert coaching for Maharashtra Board 10th Maths & Science. 90%+ results consistently. Book free demo today.',
    },
    {
      slug: '11-12-science',
      title: '11th–12th Science',
      subtitle: 'HSC Board + Entrance Ready',
      description: 'Comprehensive coaching for 11th and 12th Science students (MSBSHSE HSC Board). Dual-track preparation — Board exams and competitive entrance exams (JEE/NEET/MHT-CET). Covers Physics, Chemistry, Mathematics, and Biology with full Board and entrance-level rigour.',
      subjects: 'Physics, Chemistry, Mathematics, Biology (for NEET/MHT-CET Bio students)',
      ...
      metaTitle: '11th 12th Science Coaching in Pune | JEE NEET MHT-CET HSC | Trimitra',
      metaDescription: 'Best 11th 12th Science coaching in Talegaon Dighe Pune. HSC Board + JEE/NEET/MHT-CET preparation. Expert Physics, Chemistry, Maths tuition. Trimitra Coaching Centre.',
    },
    {
      slug: 'jee-neet-mht-cet-nata',
      title: 'Competitive Exam Excellence',
      subtitle: 'JEE Main | NEET UG | MHT-CET | NATA',
      description: 'Focused preparation for JEE Main, NEET UG, MHT-CET, and NATA. Covers complete syllabus as per official NTA, State CET Cell, and CoA guidelines. Exam-strategy-driven coaching with full-length mock test series and performance analytics.',
      subjects: 'Physics, Chemistry, Mathematics (JEE/MHT-CET), Biology (NEET/MHT-CET Bio), General Aptitude & Drawing (NATA)',
      targetTrack: 'COMPETITIVE',
      targetClass: '12th Pass / Dropper',
      duration: '1 Year (Intensive)',
      sortOrder: 3,
      whoShouldJoin: 'Class 12th students or droppers preparing for JEE Main, NEET UG, MHT-CET, or NATA. Suitable for repeaters who want a focused, personalised approach rather than large coaching institutes.',
      teachingMethodology: 'Exam-strategy-first approach. Topics covered in NTA exam priority order. Special sessions on time management, question selection strategy, elimination techniques for MCQs. Regular NTA/CoA pattern mock tests.',
      weeklyTestPlan: 'Daily: Topic-wise 30-question practice set. Weekly: Chapter-wise mock (full NTA pattern). Bi-weekly: Full-length 3-hour mock exam. Monthly: Performance analysis and strategy adjustment session.',
      doubtSolvingSystem: 'Daily doubt-solving at end of each session. Dedicated WhatsApp group for quick concept queries. One-on-one sessions for rank-improvement strategy. Pre-exam 2-week intensive revision camp.',
      studyMaterial: 'Exam-focused notes (NTA pattern), 10-year previous papers with solutions, topic-wise question banks, formula bibles, NATA drawing practice booklets, rank booster question sets.',
      batchTiming: 'Morning Intensive: 7:00 AM – 11:00 AM | Evening Batch: 4:00 PM – 8:00 PM | Sunday: Full Mock Exam 8:00 AM – 1:00 PM + Analysis 2:00 PM – 4:00 PM',
      examPattern: 'JEE Main (NTA): 90 questions | 3 hours | CBT mode | Sections: Physics (30), Chemistry (30), Maths (30). NEET UG (NTA): 200 questions (attempt 180) | 3 hours | Physics, Chemistry, Biology. MHT-CET: 150 MCQs | 3 hours | Maths/Physics/Chemistry or Bio. NATA: 2 sessions | Drawing + MCQs.',
      metaTitle: 'JEE NEET MHT-CET NATA Coaching in Pune | Trimitra Coaching Centre',
      metaDescription: 'Expert JEE Main, NEET UG, MHT-CET, and NATA coaching in Talegaon Dighe, Pune. Small batches, personalised strategy, full mock test series. Book free demo today.',
    },
  ];
