...
async function main() {
  ...
  const courseData = [
    ...
    },
    {
      ...
      metaTitle: 'JEE NEET MHT-CET NATA Coaching near Sangamner | Trimitra Coaching Centre',
      metaDescription: 'Expert JEE Main, NEET UG, MHT-CET, and NATA coaching in Talegaon Dighe near Sangamner. Small batches, personalised strategy, full mock test series. Book free demo today.',
    },
  ];
