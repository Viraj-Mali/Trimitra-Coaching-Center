  ...
  const courseData = [
    {
      ...
      title: 'Foundation Program (6th–9th)',
      subtitle: 'Build Strong Basics',
      description: 'Perfect starting point for academic excellence and conceptual clarity.',
    ...
    },
    {
      ...
      subtitle: 'Board-Focused Preparation',
      description: 'Comprehensive preparation for SSC & CBSE board exams.',
    ...
    },
    {
      ...
      subtitle: 'HSC / CBSE',
      description: 'Expert coaching for Board exams with practical insights.',
      subjects: 'Physics, Chemistry, Maths, Biology if offered',
    ...
    },
    {
      ...
      subtitle: 'Competitive Focus',
      description: 'Structured preparation for engineering, medical and CET entrance exams.',
      subjects: 'Physics, Chemistry, Maths, Biology if offered',
